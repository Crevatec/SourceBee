...
const CHAT_KB = [
  ...
  // GREETING
  {
    ...
    response: () => `Hi there! 👋 Welcome to *${CONFIG.STORE_NAME}*! 🐝\n\n*Shop It. We Source It. We Deliver It.*\n\nI'm Bee, your shopping assistant. I can help with:\n• 🛍️ Products & prices\n• 📦 Pre-orders & custom sourcing\n• 🚚 Delivery across all 36 states\n• 💳 How to pay\n• 🔐 Confirmation codes & receipts\n\nWhat would you like to know?`,
  },

  // ABOUT
  { patterns: ['about','who are you','what is sourcebee','eejay','your business','years','experience'],
    response: `*SourceBee* is a fast-growing online retail and product sourcing brand! 🐝\n\n📅 *4–5 years* in business\n🎯 *Mission:* Affordable, reliable, customer-focused shopping\n🌍 *Coverage:* All 36 states + FCT across Nigeria\n\nWe offer:\n✅ Ready-made products to buy instantly\n✅ Pre-order & custom sourcing\n✅ Doorstep delivery\n✅ Wide range — Fashion, Hair, Electronics, Home & more\n\n*Slogan:* Shop It. We Source It. We Deliver It. 🐝`,
  },
  ...
  // PRODUCTS
  {
    ...
    response: () => {
      ...
      const catLabels = { fashion:'👗 Fashion & Lifestyle', shoes:'👠 Shoes & Bags', accessories:'💍 Accessories', hair:'💇 Beauty & Hair', electronics:'📱 Gadgets & Electronics', home:'🏡 Home & Kitchen', books:'📚 Books & Stationery', pets:'🐶 Pet Products', sourcing:'📦 Request a Product' };
  ...
  // Accessories
  { patterns: ['accessory','accessories','jewellery','jewelry','necklace','bracelet','watch','sunglasses','scarf','belt','ring'],
    response: () => _showCatProducts('accessories', '💍 Accessories') },
  ...
  // CUSTOM SOURCING
  { patterns: ['source','sourcing','custom','find','cant find','looking for','request','any product','pre-order','preorder','picture','description'],
    response: `That's exactly what SourceBee does! 📦\n\n*Shop It. We Source It. We Deliver It.*\n\nHere's how to request a product:\n1. Send us a *picture, product name, or description* on WhatsApp\n2. We search our trusted supplier network\n3. We confirm availability & price\n4. You pay & we deliver to your door!\n\nWe handle:\n✅ Instant orders (in stock)\n✅ Pre-orders (sourced for you)\n✅ Hard-to-find items\n✅ Wholesale & bulk orders\n\nNo product is too hard to find! 🐝`,
  },
